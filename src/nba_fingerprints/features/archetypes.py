...
ARCHETYPE_WEIGHTS: dict[str, dict[str, float]] = {
    ...
    "isolation_creator": {
        "isolation_frequency": 1.0,
        "isolation_points_per_possession": 0.9,
        "pull_up_attempt_frequency": 0.7,
        "usage_rate": 0.7,
        "points_per_36": 0.7,
        "free_throw_attempt_rate": 0.5,
    },
    "pick_and_roll_creator": {
        "pnr_ball_handler_frequency": 1.0,
        "pnr_ball_handler_points_per_possession": 0.8,
        "assist_pct": 0.8,
        "assists_per_36": 0.7,
        "pull_up_attempt_frequency": 0.5,
        "usage_rate": 0.5,
    },
    "roll_finisher": {
        "pnr_roll_man_frequency": 1.0,
        "pnr_roll_man_points_per_possession": 0.9,
        "rim_attempt_rate": 0.8,
        "true_shooting_pct": 0.7,
        "offensive_rebound_pct": 0.5,
        "blocks_per_36": 0.4,
    },
    "movement_shooter": {
        "off_screen_frequency": 1.0,
        "off_screen_points_per_possession": 0.8,
        "catch_shoot_attempt_frequency": 0.8,
        "catch_shoot_effective_fg_pct": 0.7,
        "three_point_attempt_rate": 0.7,
    },
    "spot_up_spacer": {
        "spot_up_frequency": 1.0,
        "spot_up_points_per_possession": 0.8,
        "catch_shoot_attempt_frequency": 0.7,
        "corner_three_attempt_rate": 0.6,
        "three_point_attempt_rate": 0.6,
    },
    "cutter_slasher": {
        "cut_frequency": 1.0,
        "cut_points_per_possession": 0.9,
        "rim_attempt_rate": 0.7,
        "drives_per_36": 0.6,
        "free_throw_attempt_rate": 0.5,
    },
    "post_scorer": {
        "post_up_frequency": 1.0,
        "post_up_points_per_possession": 0.9,
        "post_touches_per_36": 0.8,
        "paint_non_ra_attempt_rate": 0.5,
        "usage_rate": 0.4,
    },
    "transition_attacker": {
        "transition_frequency": 1.0,
        "transition_points_per_possession": 0.8,
        "drives_per_36": 0.5,
        "points_per_36": 0.5,
        "pace": 0.4,
    },
